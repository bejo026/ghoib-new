...
echo "\n";
echo "\e[96m BISMILLAH.. OJO LALI DUNGO SEK   \n";
echo "\e[96m GASSSSS CUK \n";
// function change(){
        $nama = nama();
        ...
        echo color("green","OTP WES DI KIRIM CUK")."\n";
        otp:
        ...
        echo color("green","ALHAMDULLILAH WES KEDAFTAR\n");
        $token = getStr('"access_token":"','"',$verif);
        $uuid = getStr('"resource_owner_id":',',',$verif);
        echo color("nevy","+] Your access token : ".$token."\n\n");
        save("token.txt",$token);
        sleep(105);
        echo color("nevy","\nSEK LAGI DI GOLEK'KE VOCER SENG COCOK");
        echo "\n".color("nevy"," TAK CLAIMKE SEK 1: ");
        //echo "\n".color("yellow","鈴斥柖锔� Please wait  ");
        for($a=0;$a<=5;$a++){
          echo color("yellow",$a);
          sleep(1);}
        
        $code1 = request3('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESANGOFOOD0607"}');
        $message = fetch_value($code1,'"message":"','"');
        //echo ("\n".$code1);
        if(strpos($code1, 'Promo kamu sudah bisa dipakai')){
          echo "\n".color("green","馃敁鈻讹笍 Message: ".$message);}
        else{
          echo "\n".color("red","馃攼鈻讹笍 Message: ".$message);}
	     
        echo "\n".color("nevy"," TAK CLAIMKE Voucher 2: ");
        //echo "\n".color("yellow","鈴斥柖锔� Please wait");
        for($a=0;$a<=5;$a++){
          echo color("yellow",$a);
          sleep(1);}
        ...
        echo "\n".color("nevy"," TAK CLAIMKE Voucher 3: ");
        //echo "\n".color("yellow","鈴斥柖锔� Please wait");
        for($a=0;$a<=5;$a++){
          echo color("yellow",$a);
          sleep(1);}
          
        $code1 = request1('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PAKEGOFOOD00607"}');
        $message = fetch_value($code1,'"message":"','"');
       // echo "\n".$code1;
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
          echo "\n".color("green","馃敁鈻讹笍 Message: ".$message);}
 ...
 /*       $TOKEN  = "1032900146:AAE7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
     ...
     */
         setpin:
         echo "\n".color("purple"," SET PIN SAN RA CUK !!!: y/n ");
         $pilih1 = trim(fgets(STDIN));
         if($pilih1 == "y" || $pilih1 == "Y"){
         //if($pilih1 == "y" && strpos($no, "628")){
         echo color("nevy"," IKI PIN MU = 550055 ")."\n";
         $data2 = '{"pin":"550055"}';
...
echo "\n".color("nevy","馃敀鈻讹笍 Claim Voucher 1: ");
    for($a=0;$a<=5;$a++){
          echo color("yellow",$a);
          sleep(1);}
